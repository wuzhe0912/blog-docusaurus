...
## 4. Calculer la somme d'un tableau imbriqué sur plusieurs niveaux

### I. Utilisation de la récursion
...
> Si le tableau contient des objets, la méthode `flat` ne peut pas être utilisée
