...
title: 'Visão geral das perguntas de entrevista sobre mecanismos de login'
...
- [Como o mecanismo de login foi implementado em projetos anteriores?](/docs/experience/login/lv1-project-implementation)
- [Qual é a diferença entre Session-based e Token-based?](/docs/experience/login/lv1-session-vs-token)
- [Qual é a estrutura de um JWT?](/docs/experience/login/lv1-jwt-structure)
